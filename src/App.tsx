...
import { ApartmentOutlined, BugOutlined, CalendarOutlined, DatabaseOutlined, FireOutlined, HistoryOutlined, HomeOutlined, MenuOutlined, ProjectOutlined } from "@ant-design/icons";
...
export default function App() {
  ...
  return <ConfigProvider locale={zhCN} theme={theme.antd}><div style={theme.vars as CSSProperties}><Layout style={{ minHeight: "100vh" }}>
    ...
    <Content style={{ padding: mobile ? "70px 14px 28px" : "28px", marginLeft: mobile ? 0 : width, transition: "margin .2s" }}>
      ...
      {page === "current" && <CurrentPartPage />}{page === "challenge" && <DailyChallengePage />}{page === "memory" && <MemoryPage />}{page === "bestiary" && <BestiaryPage />}{page === "showcase" && <ShowcasePage />}{page === "overall" && <OverallPlanPage />}{page === "contributions" && <ContributionsPage />}{page === "completed" && <CompletedPage />}
