...
export const COURSES: Course[] = [
  ...
  { id: "world-trade", name: "走遍世界说贸易", weekday: 1, location: "线上", periods: [3], sections: [6, 7], timeRanges: [{ start: "14:00", end: "15:30" }], weeks: ALL_WEEKS, type: "选修 / 线上课程" },
  ...
  { id: "volleyball", name: "排球课", weekday: 2, location: "排球场", periods: [3], sections: [6, 7, 8], timeRanges: [{ start: "14:00", end: "16:20" }], weeks: ALL_WEEKS },
  ...
  { id: "database", name: "数据库原理与应用", weekday: 3, location: "南教502", periods: [3], sections: [6, 7], timeRanges: [{ start: "14:00", end: "15:30" }], weeks: ALL_WEEKS },
