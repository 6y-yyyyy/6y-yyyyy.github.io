...
export const COURSES: Course[] = [
  ...
  { id: "probability", name: "概率论与数理统计B", weekday: 2, location: "南教319", periods: [2, 3], sections: [3, 4, 5, 6, 7, 8], timeRanges: [{ start: "10:00", end: "12:20" }, { start: "14:00", end: "16:20" }], weeks: ALL_WEEKS },
  ...
  { id: "marxism", name: "马克思主义基本原理", weekday: 3, location: "南教113", periods: [2, 3], sections: [3, 4, 5, 6, 7, 8], timeRanges: [{ start: "10:00", end: "12:20" }, { start: "14:00", end: "16:20" }], weeks: ALL_WEEKS },
